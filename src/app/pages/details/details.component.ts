      ...
      this.weather.getForecast(this.city).subscribe((data: any) => {
        ...
        for (let i = 0; i < data.length; i++) {
          ...
          if (
            ...
            console.log('Day 1'+this.day1Name)
            ...
            days[date] !== this.day1Name
              ...
              console.log('Day 2'+this.day2Name)
            ...
            console.log('Day 3'+this.day3Name)
            ...
            days[date] !== this.day3Name
              ...
              console.log('Day 4'+this.day4Name)
            ...
            this.day5Name = days[date+1];
            console.log('Day 5'+this.day5Name)
